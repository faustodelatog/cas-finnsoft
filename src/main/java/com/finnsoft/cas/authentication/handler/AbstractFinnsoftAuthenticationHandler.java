 ...
 * </p>
 */
public abstract class AbstractFinnsoftAuthenticationHandler extends
    AbstractPreAndPostProcessingAuthenticationHandler {

    /** Default class to support if one is not supplied. */
    private static final Class<FinnsoftCredential> DEFAULT_CLASS = FinnsoftCredential.class;
    ...
    protected final boolean doAuthentication(final Credentials credentials)
        ...
        return authenticateFinnsoft((FinnsoftCredential) credentials);
    }
     ...
     */
    protected abstract boolean authenticateFinnsoft(
        final FinnsoftCredential credentials)
        throws AuthenticationException;
